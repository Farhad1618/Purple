//
//  newCeateButtonBacground.swift
//  Purple
//
//  Created by Farhad on 20/06/2023.
//
import CoreData

import SwiftUI

public struct newCeateButtonBacground: View {
...
struct ViscosityCanvas<Symbols: View> : View {
    ...
    init(color: Color, thresholdMin: CGFloat = 0.2, thresholdMax: CGFloat? = nil, radius: CGFloat = 12, @ViewBuilder symbols: @escaping () -> Symbols) {
        self.color = color
...
struct newCeateButtonBacground_Previews: PreviewProvider {
