...
//  Purple
//
//  Created by Farhad on 06/06/2023.
//
...
//            Text("Value: \(x)")
            ...
            Canvas { context, size in
                context.fill(path(in: CGRect(x: 0, y: 0, width: size.width, height: size.height), x: x, x2: x2), with: .linearGradient(Gradient(colors: [ Color("Text2"), Color("Icon"),Color("Background"), Color.black ]), startPoint: CGPoint(x: 0, y: 0), endPoint: CGPoint(x: 400, y: 400)))
            }
